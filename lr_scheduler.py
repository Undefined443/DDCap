...
def build_scheduler(args, optimizer, n_iter_per_epoch):
    ...
    decay_steps = 0 # int(config.TRAIN.LR_SCHEDULER.DECAY_EPOCHS * n_iter_per_epoch)
    multi_steps = 0 # [i * n_iter_per_epoch for i in config.TRAIN.LR_SCHEDULER.MULTISTEPS]
